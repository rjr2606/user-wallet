...
public class ComputeCharges {
	...
	public static Fee senderFee(double transactionAmount) {
		...
		netAmount = new BigDecimal(transactionAmount + commission + charge).setScale(2, RoundingMode.DOWN)
				.doubleValue();
	...
	public static Fee recieverFee(double transactionAmount) {
		double commission, charge, netAmount;
		Fee feeDetails = new Fee();
